	...
	if( isset ($sessionManager)  && $sessionManager->isAuthorized () ) {
		...
		for ($i = 0; $i < count ($x10_data); $i++) {
			...
			$tableView->addRow ( array (
				...
				TableView::createCell ('on', "<a href='../Proxy/index.php?url=http://192.168.2.62:1771/?houseCode=$this_house&unitCode=$this_unit&statusCode=+'>ON</a>" ),
				TableView::createCell ('off', "<a href='../Proxy/index.php?url=http://192.168.2.62:1771/?houseCode=$this_house&unitCode=$this_unit&statusCode=-'>OFF</a>" ),
